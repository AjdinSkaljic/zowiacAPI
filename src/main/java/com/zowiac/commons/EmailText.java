...
public class EmailText {
    ...
    public static String createTeilnahme(OrderEntity orderEntity) {
        String text = "Lieber registrierter Teilnehmer, \n\n" +
                ...
                "im \n" +
                "Otto-Stern-Zentrum\n" +
                "in der Ruth-Moufang-Straße 2, 60438 Frankfurt am Main\n\n" +
        ...
        text += "Die ZOWIAC Konferenz ist die Erste Gesamtdeutsche Konferenz über Invasive Raubsäuger und wir freuen uns sehr, dass Sie sich für die Teilnahme angemeldet haben.\n\n ";
        ...
        text += "Informieren Sie Ihr berufliches Netzwerk über die Konferenz und laden Sie es zur Teilnahme ein!n\n";

        text += "Vielen Dank für Ihre Teilnahme an der Konferenz ZOWIAC - Wildtierforschung. Wir freuen uns darauf, Sie zwischen dem 14. und 15. September in Frankfurt auf der Veranstaltung begrüßen zu dürfen.\n\n";
